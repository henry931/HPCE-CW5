...
{
	__m128i altzero, bltzero, xor_result, signedmin, signedmax, resultsame, resultdiff;
    
	altzero = _mm_cmplt_epi16(a, _mm_set1_epi16(0));
	bltzero = _mm_cmplt_epi16(b, _mm_set1_epi16(0));
	xor_result = _mm_xor_si128(altzero, bltzero);
	signedmin = _mm_min_epi16(a, b);
	signedmax = _mm_max_epi16(a, b);
	resultsame = _mm_andnot_si128(xor_result, signedmin);
	resultdiff = _mm_and_si128(xor_result, signedmax);
...
__m128i max16(__m128i a, __m128i b)
{
	...
	signedmin = _mm_min_epi16(a, b);
	signedmax = _mm_max_epi16(a, b);
	resultsame = _mm_andnot_si128(xor_result, signedmax);
	resultdiff = _mm_and_si128(xor_result, signedmin);
	return _mm_or_si128(resultsame, resultdiff);
}
...
{
	__m128i altzero, bltzero, agtbsigned, agtbunsignedpt1, agtbunsignedpt2, xor_result, agtbunsigned, resulta, resultb;
    
	altzero = _mm_cmplt_epi32(a, _mm_set1_epi32(0));
	bltzero = _mm_cmplt_epi32(b, _mm_set1_epi32(0));
	xor_result = _mm_xor_si128(altzero, bltzero);
	agtbsigned = _mm_cmpgt_epi32(a, b);
	agtbunsignedpt1 = _mm_andnot_si128(xor_result, agtbsigned);
	agtbunsignedpt2 = _mm_andnot_si128(agtbsigned, xor_result);
